...
public class ASTFractal extends ASTFracExp {
	 ...
	 * 
	 * @param <S>
	 *            The input type (type of state or context)
	 * @param <T>
	 *            The output type
	 * @param v
	 *            The visitor to be used with this tree.
	 * @param state
	 *            The context or state needed by the visitor
	...
	public String toString() {
		return "FRACTAL " + this.body.toString();
	}
