...
public interface Visitor<S, T> {
    ...
    /**
     * Set the default level for rendering
     * 
     * @param form The LEVEL statement
     * @param state The current interpreter state
     * @return The result of visiting LEVEL
     * @throws FractalException if execution of this statement fails
     */
    public T visitASTSetLevel(ASTSetLevel form, S state) throws FractalException;

    /**
     * Set the default scale for rendering
     * 
     * @param form The SCALE statement
     * @param state The current interpreter state
     * @return The result of visiting SCALE
     * @throws FractalException if execution of this statement fails
     */
    public T visitASTSetScale(ASTSetScale form, S state) throws FractalException;
